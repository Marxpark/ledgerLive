...
typedef enum {
    ...
    AMOUNT,
    TOKEN_RECEIVED,
    BOOL_OPTION, // THESE 4 PARAMS HANDLE DEPOSIT, WITHDRAW
    ADDRESS,
    ALLOWANCE, // these 2 handle approve
    UNEXPECTED_PARAMETER,
} parameter;


extern const uint8_t *const TEST_SELECTORS[NUM_SELECTORS];
...
typedef struct context_t {
    ...
    uint8_t offset;     // Offset at which the array or struct starts.
